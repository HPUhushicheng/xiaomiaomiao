<template>
  <div id="box">
    <div class="left">
      ...
      <el-input v-model="studentid" placeholder="请输入学号" class="input"></el-input>
...
export default {
  ...
  methods: {
    all() {
      //查找info表全部数据
      axios
        .get("http://127.0.0.1:666/list/all")
        .then(res => {
    ...
    del() {
      //删除操作
      axios
        .get("http://127.0.0.1:666/list/del", {
          params: {
            id: this.id
          }
        })
    ...
    get() {
      //查询操作
      axios
        .get("http://127.0.0.1:666/list/get", {
          params: {
            id: this.id
          }
        })
    ...
    add() {
      //添加操作
      axios
        .get("http://127.0.0.1:666/list/add", {
          params: {
            id: this.id,
            name: this.name,
    ...
    update() {
      //修改操作
      axios
        .get("http://127.0.0.1:666/list/update", {
          params: {
            id: this.id,
            name: this.name,
            password: this.password,
